...
const contractABI = [
	...
	},
	{
		...
		"outputs": [
			...
			{
				"internalType": "enum MinorityWinsGame.GameStage",
				"name": "stage",
				"type": "uint8"
			},
			{
		...
		"outputs": [
			{
				...
				"internalType": "struct MinorityWinsGame.Commit",
				"name": "",
				"type": "tuple"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct MinorityWinsGame.Game",
				"name": "",
				"type": "tuple"
			}
		],
...
// Example usage
export default MinorityWinsGame;

// Usage in React component:
/*
import MinorityWinsGame from './MinorityWinsGame';

const contractAddress = '0x...'; // Your deployed contract address
const abi = [...]; // Your contract ABI

const game = new MinorityWinsGame(contractAddress, abi);
